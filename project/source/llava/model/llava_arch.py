...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        # if type(images) is list or images.ndim == 5:
            ...
            #
            #     0/0
            # tokenizer = transformers.AutoTokenizer.from_pretrained("liuhaotian/llava-v1.5-7b",cache_dir="./downloads/",model_max_length=2048,padding_side="right")
